...
const Entries = () => {
    ...
    // const newEntry = { "dish": "", "ingredients": "", "calories": 0, fat: 0 }
    let count =
    ...
    return (
        <div >
            <Container>
                <Button className='m-5' onClick={() => setAddNewEntry(true)}>Track today's calories</Button>
            </Container>
            <Container>
            ...
            <Modal style={{ marginTop: "150px" }} show={addNewEntry} onHide={() => setAddNewEntry(false)} centred>
                ...
                <Modal.Body>
                    <Form.Group>
                        ...
                        <Form.Control min={0} type="number" onChange={(event) => { newEntry.fat = event.target.value }}></Form.Control>
                    </Form.Group>
                    <div style={{ display: 'flex', justifyContent: 'center' }}>
                        <Button className='mt-3' onClick={() => addSingleEntry()}>Add</Button>&nbsp;&nbsp;&nbsp;
                        <Button className='mt-3' onClick={() => setAddNewEntry(false)}>Cancel</Button>
                    </div>
                    <p className='m-3' style={{ textAlign: "center", color: "red" }}>{error}</p>
                </Modal.Body>
    ...
    function addSingleEntry() {
        if (newEntry.ingredients && newEntry.dish && newEntry.calories) {
